...
from app.core.exceptions import DashboardConflictError, DashboardNotFoundError, DashboardPermissionError
...
async def test_redeem_selects_soonest_calls_upstream_and_invalidates_cache() -> None:
    ...
    # Cache was invalidated for the account after success.
